...
\begin{example}
    \exmp{%%INPUT
        \caseFile{2024/A_Maya/in/1.in}
    }{%%OUTPUT
        \caseFile{2024/A_Maya/out/1.out}
    }%%END-OUTPUT
    \exmp{%%INPUT
        \caseFile{2024/A_Maya/in/2.in}
    }{%%OUTPUT
        \caseFile{2024/A_Maya/out/2.out}
    }%%END-OUTPUT
    \exmp{%%INPUT
        \caseFile{2024/A_Maya/in/3.in}
    }{%%OUTPUT
        \caseFile{2024/A_Maya/out/3.out}
    }%%END-OUTPUT
\end{example}
