...
\begin{figure}[h]
    \centering
    \input{2024/RedDeTransporte/images/graph1}
\end{figure}
...
\begin{figure}[h]
    \centering
    \input{2024/RedDeTransporte/images/graph2}
\end{figure}

La distancia de $640.31 km$ son transportadas por los camiones propios de Amazon, mientras que el resto es transportado por contratistas. Por lo tanto, el monto máximo que se pagará a un contratista será de $492.44$ soles.
